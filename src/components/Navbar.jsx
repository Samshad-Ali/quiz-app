...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center sticky top-0 z-40 px-4 w-full bg-white shadow-md shadow-gray-200">
      <div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative cursor-pointer">
          <div className="w-4 h-4 grid place-items-center absolute translate-x-[90%] translate-y-[-40%] text-xs rounded-sm bg-red-600 text-white">
            2
          </div>
          <TbMessages size={22} />
        </div>
